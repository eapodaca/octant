...
func (n *NamespacesManager) Start(ctx context.Context, state octant.State, s octant.OctantClient) {
...
func (n *NamespacesManager) runUpdate(state octant.State, client octant.OctantClient) PollerFunc {
	var previous []byte
